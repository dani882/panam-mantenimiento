...
public class AdministracionUsuarios extends JInternalFrame {
	...
	public AdministracionUsuarios() {
		...
		layeredPaneAcceso.setBorder(new TitledBorder(
		...
		btnGuardar.setIcon(new ImageIcon(AdministracionUsuarios.class.getResource("/iconos32x32/registroUsuario32x32.png")));
		...
		btnEditar.setIcon(new ImageIcon(AdministracionUsuarios.class.getResource("/iconos32x32/edit-male-user-icon32x32.png")));
